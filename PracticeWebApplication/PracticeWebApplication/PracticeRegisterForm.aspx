<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PracticeRegisterForm.aspx.cs" Inherits="PracticeWebApplication.PracticeRegisterForm" %>
            ...
            <div>
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td>
                            <br />
                            <asp:Button ID="Button1" runat="server" Text="Register" CssClass="btn btn-primary" OnClick="ButtonClick" />
                        </td>
                    </tr>
                </table>
